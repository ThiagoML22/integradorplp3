...
// Consultar productos de la categoría 'creatina'
$stmt = $conn->prepare("SELECT * FROM productos WHERE categoria = 'creatina' ORDER BY fecha_agregado DESC");
$stmt->execute();
...
<head>
    ...
    <title>Elite Suplementos - Creatinas</title>
</head>
<body>
